		...
		<div class="row-fluid">
			...
			<div class="add">
				<a class="btn btn-success" onclick="add();">new</a> <a
					...
					class="btn btn-success" onclick="del('deleteVesselById');">delete</a>
			</div>
			<div class="w">
				<div class="span12">
						...
						<tbody id="tbody">
							<s:iterator value="pageBean.list">
								<tr>
									...
									<td><s:property value='callSign' /></td>
            ...
            首页&nbsp;&nbsp;&nbsp;上一页
						...
						<s:else>
							<a href="listVesselByPage">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="listVesselByPage?page=<s:property value="pageBean.currentPage - 1"/>">上一页</a>
						</s:else>

						<s:if test="pageBean.currentPage != pageBean.totalPage-1">
							<a
								href="listVesselByPage?page=<s:property value="pageBean.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="listVesselByPage?page=<s:property value="pageBean.totalPage-1"/>">尾页</a>
						</s:if>
			...
			<div id="addModal" class="modal hide fade" tabindex="-1"
				...
				<div class="modal-header">
					...
					<h3 id="myModalLabel">new vessel</h3>
				</div>
				<form class="form-horizontal" action="addVessel">
					<div class="modal-body">
						<div class="control-group">
							<label class="control-label" for="vId">vId</label>
							<div class="controls">
								<input type="text" placeholder="vId"
									name="vessel.vId">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" placeholder="callSign"
									name="vessel.callSign">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="operator">operator</label>
							<div class="controls">
								<s:select list="listOperator" listValue="name" listKey="id" name="vessel.operator.id" headerKey="0" headerValue="请选择"></s:select>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="group">group</label>
							<div class="controls">
								<s:select list="listGroup" listValue="name" listKey="id" name="vessel.group.id" headerKey="0" headerValue="请选择"></s:select>
							</div>
						</div>
					</div>
			...
			<div id="editModal" class="modal hide fade" tabindex="-1"
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">×</button>
					<h3 id="myEditModalLabel">edit vessel</h3>
				</div>
				<form class="form-horizontal" action="modifyVessel">
					<div class="modal-body">
						...
						<div class="control-group">
							<label class="control-label" for="operator">operator</label>
							<div class="controls">
								<s:select id="operator" list="listOperator" listValue="name" listKey="id" name="vessel.operator.id" headerKey="0" headerValue="请选择"></s:select>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="group">group</label>
							<div class="controls">
								<s:select id="group" list="listGroup" listValue="name" listKey="id" name="vessel.group.id" headerKey="0" headerValue="请选择"></s:select>
							</div>
						</div>
					</div>
					<div class="modal-footer">
