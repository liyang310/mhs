		...
		<div class="row-fluid">
			...
			<div class="add">
				<a class="btn btn-success" onclick="add();">new</a> <a
					...
					class="btn btn-success" onclick="del('deleteOperatorById');">delete</a>
			</div>
			<div class="w">
				<div class="span12">
            ...
            首页&nbsp;&nbsp;&nbsp;上一页
						...
						<s:else>
							<a href="listOperatorByPage">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="listOperatorByPage?page=<s:property value="pageBean.currentPage - 1"/>">上一页</a>
						</s:else>

						<s:if test="pageBean.currentPage != pageBean.totalPage-1">
							<a
								href="listOperatorByPage?page=<s:property value="pageBean.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="listOperatorByPage?page=<s:property value="pageBean.totalPage-1"/>">尾页</a>
						</s:if>
			...
			<div id="addModal" class="modal hide fade" tabindex="-1"
				...
				<div class="modal-header">
					...
					<h3 id="myModalLabel">new operator</h3>
				</div>
				<form class="form-horizontal" action="addOperator">
					<div class="modal-body">
						...
						<div class="control-group">
							...
							<div class="controls">
								<s:select list="listCompany" listValue="name" listKey="id" name="operator.company.id" headerKey="0" headerValue="请选择"></s:select>
							</div>
						</div>
					</div>
			...
			<div id="editModal" class="modal hide fade" tabindex="-1"
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">×</button>
					<h3 id="myEditModalLabel">edit operator</h3>
				</div>
				<form class="form-horizontal" action="modifyOperator">
					<div class="modal-body">
						...
						<div class="control-group">
							<label class="control-label" for="company">company</label>
							<div class="controls">
								<s:select id="company" list="listCompany" listValue="name" listKey="id" name="operator.company.id" headerKey="0" headerValue="请选择"></s:select>
							</div>
						</div>
					</div>
					<div class="modal-footer">
